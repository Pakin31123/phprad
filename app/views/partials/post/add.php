                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-content"  value="<?php  echo $this->set_field_value('content',''); ?>" type="text" placeholder="Enter Content"  required="" name="content"  class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="auther">Auther <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-auther"  value="<?php  echo $this->set_field_value('auther',''); ?>" type="text" placeholder="Enter Auther"  required="" name="auther"  class="form-control " />
