...
class PostController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array('id', 'headline', 'title', 'category', 'content', 'auther', 'status');
	...
	function add(){
		if(is_post_request()){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename = 'post';
			$fields = $this->fields = array('headline','title','category','content','auther','status'); //insert fields
	...
	function edit($rec_id = null){
		...
		$this->rec_id = $rec_id;
		$tablename = $this->tablename = 'post';
		$fields = $this->fields = array('id','headline','title','category','content','auther','status'); //editable fields
		if(is_post_request()){
			Csrf :: cross_check();
			$postdata = $this->transform_request_data($_POST);
			$this->rules_array = array(
